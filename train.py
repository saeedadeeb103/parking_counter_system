...
class SimpleCNN(pl.LightningModule):
    def __init__(self):
        ...
        self.fc2 = torch.nn.Linear(128, 2)  # 2 output classes (empty and not empty)
    ...
    def configure_optimizers(self):
        return optim.SGD(self.parameters(), lr=0.0001, weight_decay=2e-4)
    ...
    def validation_step(self, batch, batch_idx):
        ...
        # Log the loss and accuracy for this validation step
